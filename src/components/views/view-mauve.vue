...
div
  ...
  // LEVER
  j-panel(icon='business', title='Slider', :width='600', :height='720', :x='235', :y='10')
    div.j-tray.area.panel-item-grow(slot='content')
      br 
      br
      j-lever(v-model='$state.leverValue', rest='50%', :markers='true', :labelAlways='true', :range={
        'min': -10000,
        '35%': -1200,
        '50%': 0,
        '65%': 1200,
...
export default {
  ...
  components: {
    jPanel, jItem, jCanvas, jUploadZone, jCollection, DragEffects, jComponent, jDebug, jObject, jLever
  },
  mounted () {
